...
Si necesitas profundizar en la arquitectura o el plan de desarrollo:

- [Arquitectura (Español)](docs/es/ARCHITECTURE.md)
- [Architecture (English)](docs/en/ARCHITECTURE.md)
- [Guía de Inicio (Español)](docs/es/README.md)
